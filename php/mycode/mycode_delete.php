...
<body>
  <?php
    try{
        ...
        $sql = 'SELECT name,data FROM mycode WHERE code = ?';
        ...
        if($picture_name == ''){
          ...
          $disp_data = '<img id="picture-dalete" src="../../images/mycode/'.$picture_data.'">';
  ...
  <br/>
  この画像を削除してよろしいですか？<br/>
  <form method="post" action="mycode_delete_done.php">
