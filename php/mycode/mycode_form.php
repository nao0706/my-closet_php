...
<section id="closet" class="view">
  ...
  <div id="cover">
    <h1 id="cover__title">MyCode</h1>
  </div>
  <nav class="globalnav">
      <div class="container">
        <div class="row">
          <ul class="globalnav-list">
            <li><a href="mycode_form.php">MyCode</a></li>
...
<div id="main">
  <div class="add-item">  
    <input id="add-button" type="button" onclick="location.href='mycode_add.php'" value="アイテムの追加">
  </div>
<?php
    try{
        ...
        while(true){
            ...
            print('<div id="cloth-item"><img  src="../../images/mycode/'.$picture_data.'">');
