...
<body>
  <?php
    try{
        ...
        $sql = 'SELECT name,data FROM myothers WHERE code = ?';
        ...
        if($picture_name == ''){
          ...
          $disp_data = '<img id="picture-dalete" src="../../images/myothers/'.$picture_data.'">';
  ...
  <br/>
  この画像を削除してよろしいですか？<br/>
  <form method="post" action="myothers_delete_done.php">
