      ...
      <div class="container">
        <div class="row">
          <ul class="globalnav-list2">
            ...
            <li><a href="myothers_form.php">Others</a></li>
          </ul>
        </div>
      </div>
    </nav>
...
<div id="main">
    <div class="add-item">  
      <input type="button" onclick="location.href='myothers_add.php'" value="アイテムの追加">
    </div>
    <?php
        try{
            ...
            $sql = 'SELECT * FROM myothers WHERE 1';
            ...
            print('<form  method="post" action="myothers_branch.php">');
            ...
            while(true){
              ...
              //var_dump($rec);
                ...
                print('<div id="cloth-item"><img  src="../../images/myothers/'.$picture_data.'">');
