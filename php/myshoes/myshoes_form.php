...
<div id="main">
  <div class="add-item">  
    <input type="button" onclick="location.href='myshoes_add.php'" value="アイテムの追加">
  </div>
  <?php
      try{
          ...
          $sql = 'SELECT * FROM myshoes WHERE 1';
          ...
          print('<form  method="post" action="myshoes_branch.php">');
          ...
          while(true){
            ...
            //var_dump($rec);
              ...
              print('<div id="cloth-item"><img  src="../../images/myshoes/'.$picture_data.'">');
