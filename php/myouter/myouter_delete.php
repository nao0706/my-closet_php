...
<body>
  <?php
    try{
        ...
        $sql = 'SELECT name,data FROM myouter WHERE code = ?';
        ...
        if($picture_name == ''){
          ...
          $disp_data = '<img id="picture-dalete" src="../../images/myouter/'.$picture_data.'">';
  ...
  <br/>
  この画像を削除してよろしいですか？<br/>
  <form method="post" action="myouter_delete_done.php">
