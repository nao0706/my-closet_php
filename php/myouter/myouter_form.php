      ...
      <div class="container">
        <div class="row">
          <ul class="globalnav-list">
            ...
            <li><a href="myouter_form.php">Outer</a></li>
...
<div id="main">
  <div class="add-item">  
    <input type="button" onclick="location.href='myouter_add.php'" value="アイテムの追加">
  </div>
  <?php
      try{
          ...
          $sql = 'SELECT * FROM myouter WHERE 1';
          ...
          print('<form  method="post" action="myouter_branch.php">');
          ...
          while(true){
            ...
            //var_dump($rec);
              ...
              print('<div id="cloth-item"><img  src="../../images/myouter/'.$picture_data.'">');
