      ...
      <div class="container">
        <div class="row">
          <ul class="globalnav-list2">
            ...
            <li><a href="mybags_form.php">Bags</a></li>
...
<div id="main">
  <div class="add-item">  
    <input type="button" onclick="location.href='mybags_add.php'" value="アイテムの追加">
  </div>
    <?php
        try{
            ...
            $sql = 'SELECT * FROM mybags WHERE 1';
            ...
            print('<form  method="post" action="mybags_branch.php">');
            ...
            while(true){
              ...
              //var_dump($rec);
                ...
                print('<div id="cloth-item"><img  src="../../images/mybags/'.$picture_data.'">');
