      ...
      <div class="container">
        <div class="row">
          <ul class="globalnav-list">
            ...
            <li><a href="mypants_form.php">Pants</a></li>
          </ul>
        </div>
      </div>
    </nav>
      ...
      <div class="container">
        <div class="row">
          <ul class="globalnav-list2">
            ...
            <li><a href="../myaccessory/myaccessory_form.php">Accessory</a></li>
...
<div id="main">
  <div class="add-item">  
    <input type="button" onclick="location.href='mypants_add.php'" value="アイテムの追加">
  </div>
  <?php
      try{
          ...
          $sql = 'SELECT * FROM mypants WHERE 1';
          ...
          print('<form  method="post" action="mypants_branch.php">');
          ...
          while(true){
            ...
            //var_dump($rec);
              ...
              print('<div id="cloth-item"><img  src="../../images/mypants/'.$picture_data.'">');
