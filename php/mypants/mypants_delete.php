...
<body>
  <?php
    try{
        ...
        $sql = 'SELECT name,data FROM mypants WHERE code = ?';
        ...
        if($picture_name == ''){
          ...
          $disp_data = '<img id="picture-dalete" src="../../images/mypants/'.$picture_data.'">';
  ...
  <br/>
  この画像を削除してよろしいですか？<br/>
  <form method="post" action="mypants_delete_done.php">
