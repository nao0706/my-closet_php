...
<body>
  <?php
    try{
        ...
        $sql = 'SELECT name,data FROM mytops WHERE code = ?';
        ...
        if($picture_name == ''){
          ...
          $disp_data = '<img id="picture-dalete" src="../../images/mytops/'.$picture_data.'">';
  ...
  <br/>
  この画像を削除してよろしいですか？<br/>
  <form method="post" action="mytops_delete_done.php">
