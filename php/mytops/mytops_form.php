      ...
      <div class="container">
        <div class="row">
          <ul class="globalnav-list">
            ...
            <li><a href="mytops_form.php">Tops</a></li>
...
<div id="main">
  <div class="add-item">  
    <input type="button" onclick="location.href='mytops_add.php'" value="アイテムの追加">
  </div>
  <?php
      try{
          ...
          $sql = 'SELECT * FROM mytops WHERE 1';
          ...
          print('<form  method="post" action="mytops_branch.php">');
          ...
          while(true){
              ...
              print('<div id="cloth-item"><img  src="../../images/mytops/'.$picture_data.'">');
